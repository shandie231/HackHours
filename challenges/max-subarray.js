...
const karray1 = [-2,1,-3,4,-1,2,1,-5,4];
// const karray2 = [1];
// const karray3 = [5,4,-1,7,8];
// const karray4 = [-100, -20, -5, -10];
// const karray5 = [1,2,-1,-2,2,1,-2,1,4,-5,4];
// const karray6 = [1, -2, 3, 10, -4, 7, 2, -5]

console.log(kadanesMaxSubarray(karray1));
// console.log(kadanesMaxSubarray(karray2));
// console.log(kadanesMaxSubarray(karray3));
// console.log(kadanesMaxSubarray(karray4));
// console.log(kadanesMaxSubarray(karray5));
// console.log(kadanesMaxSubarray(karray6));
